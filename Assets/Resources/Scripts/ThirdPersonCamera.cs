...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	// Update optimal distance based on scroll wheel input
	{
        ...
        this.transform.position += new Vector3(movementX, 0, movementZ);
    ...
    //player has moved camera needs to be updated.
    public void setMovement(float movX, float movY, float movZ)
    {
        movementX = movX;
        movementZ = movZ;
    }
